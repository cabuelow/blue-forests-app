...
')),
  ...
  tabPanel('Data sources',
           ...
           box(title="Data sources",
               ...
               tags$div(tags$a("Alongi, D. M. (2018). Blue Carbon: Coastal Sequestration for Climate Change Mitigation. Springer Nat. Available at: https://www.researchgate.net/publication/343486022.", href="https://www.researchgate.net/publication/343486022", target="_blank")
),tags$br(),
               tags$div(tags$a("Bunting, P., Rosenqvist, A., Lucas, R. M., Rebelo, L. M., Hilarides, L., Thomas, N., et al. (2018). The global mangrove watch - A new 2010 global baseline of mangrove extent. Remote Sens. 10, 1669. doi:10.3390/rs10101669.", href="https://www.mdpi.com/2072-4292/10/10/1669", target="_blank")
),tags$br(),
               tags$div(tags$a("CIESIN (2018). Documentation for the Gridded Population of the World, Version 4 (GPWv4), Revision 11 Data Sets. Palisades NY NASA Socioecon. Data Appl. Cent. Accessed [05 01 2022].", href="https://sedac.ciesin.columbia.edu/data/collection/gpw-v4/documentation", target="_blank")
),tags$br(),
               tags$div(tags$a("CIESIN (2021). Low Elevation Coastal Zone (LECZ) Urban-Rural Population and Land Area Estimates, Version 3. Palisades, NY: NASA Socioeconomic Data and Applications Center (SEDAC). https://doi.org/10.7927/d1x1-d702. Accessed 12 01 2022.", href="https://doi.org/10.7927/d1x1-d702", target="_blank")
),tags$br(),
               tags$div(tags$a("Eger, A. M., Marzinelli, E. M., Rodrigo, B., Blain, C., Blamey, L., Carnell, P. E., et al. (2021). The economic value of fisheries, blue carbon, and nutrient cycling in global marine forests. EcoEvoRxiv. doi:10.32942/osf.io/n7kjs.", href="https://doi.org/10.32942/osf.io/n7kjs", target="_blank")
),tags$br(),
               tags$div(tags$a("FAO (2020). Fish, seafood – food supply quantity (kg/capita/yr). https://www.fao.org/faostat/en/#data/FBS.", href="https://www.fao.org/faostat/en/#data/FBS", target="_blank")
),tags$br(),
               tags$div(tags$a("Fourqurean, J. W., Duarte, C. M., Kennedy, H., Marbà, N., Holmer, M., Mateo, M. A., et al. (2012). Seagrass ecosystems as a globally significant carbon stock. Nat. Geosci. 5, 505–509. doi:10.1038/ngeo1477.", href="https://doi.org/10.1038/ngeo1477", target="_blank")
),tags$br(),
               tags$div(tags$a("Halpern, B. S., Frazier, M., Afflerbach, J., Lowndes, J. S., Micheli, F., O’Hara, C., et al. (2019). Recent pace of change in human impact on the world’s ocean. Sci. Rep. 9, 11609. doi:10.1038/s41598-019-47201-9.", href="https://doi.org/10.1038/s41598-019-47201-9", target="_blank")
),tags$br(),
               tags$div(tags$a("IUCN (2021). The IUCN Red List of Threatened Species. Version 2021-3. https://www.iucnredlist.org. Accessed on [01 December 2021].", href="https://www.iucnredlist.org", target="_blank")
),tags$br(),
               tags$div(tags$a("Jayathilake, D. R. M., and Costello, M. J. (2020). A modelled global distribution of the kelp biome. Biol. Conserv. 252. doi:10.1016/j.biocon.2020.108815.", href="https://doi.org/10.1016/j.biocon.2020.108815", target="_blank")
),tags$br(),
               tags$div(tags$a("Kaufmann, D., Kraay, A., The, M. M., and Bank, W. (2010). The Worldwide Governance Indicators Methodology and Analytical Issues. Available at: www.govindicators.org.", href="https://www.govindicators.org", target="_blank")
),tags$br(),
               tags$div(tags$a("Knapp, K. R., Kruk, M. C., Levinson, D. H., Diamond, H. J., and Neumann, C. J. (2010). The international best track archive for climate stewardship (IBTrACS). Bull. Am. Meteorol. Soc. 91, 363–376. doi:10.1175/2009BAMS2755.1.", href="https://doi.org/10.1175/2009BAMS2755.1", target="_blank")
),tags$br(),
               tags$div(tags$a('Krumhansl, K. A., Okamoto, D. K., Rassweiler, A., Novak, M., Bolton, J. J., Cavanaugh, K. C., et al. (2016). Global patterns of kelp forest change over the past half-century. Proc. Natl. Acad. Sci. U. S. A. 113, 13785–13790. doi:10.1073/pnas.1606102113.', href="https://doi.org/10.1073/pnas.1606102113", target="_blank")
),tags$br(),
               tags$div(tags$a('Linke, S., Lehner, B., Ouellet Dallaire, C., Ariwi, J., Grill, G., Anand, M., et al. (2019). Global hydro-environmental sub-basin and river reach characteristics at high spatial resolution. Sci. data 6, 283. doi:10.1038/s41597-019-0300-6. This product [Blue Forests] incorporates data from the HydroSHEDS database which is © World Wildlife Fund, Inc. (2006-2013) and has been used herein under license. WWF has not evaluated the data as altered and incorporated within [Blue Forests], and therefore gives no warranty regarding its accuracy, completeness, currency or suitability for any particular purpose. Portions of the HydroSHEDS database incorporate data which are the intellectual property rights of © USGS (2006-2008), NASA (2000-2005), ESRI (1992-1998), CIAT (2004-2006), UNEP-WCMC (1993), WWF (2004), Commonwealth of Australia (2007), and Her Royal Majesty and the British Crown and are used under license. The HydroSHEDS database and more information are available at http://www.hydrosheds.org.', href="http://doi.org/10.1038/s41597-019-0300-6", target="_blank")
),tags$br(),
               tags$div(tags$a('Mcowen, C., Weatherdon, L., Van Bochove, J., Sullivan, E., Blyth, S., Zockler, C., et al. (2017). A global map of saltmarshes. Biodivers. Data J. doi:https://doi.org/10.3897/BDJ.5.e11764.', href='https://doi.org/10.3897/BDJ.5.e11764', target='_blank')
),tags$br(),
               tags$div(tags$a('Menéndez, P., Losada, I. J., Torres-Ortega, S., Narayan, S., and Beck, M. W. (2020). The Global Flood Protection Benefits of Mangroves. Sci. Rep. 10. doi:10.1038/s41598-020-61136-6.', href='https://doi.org/10.1038/s41598-020-61136-6', target='_blank')
),tags$br(),
               tags$div(tags$a('Sanderman, J., Hengl, T., Fiske, G., Solvik, K., Adame, M. F., Benson, L., et al. (2018). A global map of mangrove forest soil carbon at 30 m spatial resolution. Environ. Res. Lett. 13. doi:10.1088/1748-9326/aabe1c.', href='https://doi.org/10.1088/1748-9326/aabe1c', target='_blank')
),tags$br(),
               tags$div(tags$a('Simard, M., Fatoyinbo, L., Smetanka, C., Rivera-Monroy, V. H., Castañeda-Moya, E., Thomas, N., et al. (2019). Mangrove canopy height globally related to precipitation, temperature and cyclone frequency. Nat. Geosci. 12, 40–45. doi.org/10.1038/s41561-018-0279-1.', href='https://doi.org/10.1038/s41561-018-0279-1', target='_blank')
),tags$br(),
               tags$div('Spillias, S. in prep. Mapping the Global Potential for Seaweed Farming. University of Queensland.
'),tags$br(),
               tags$div(tags$a('The Nature Conservancy (2022). Modelled mangrove commercial finfish enhancement; Mapping ocean wealth portal. https://maps.oceanwealth.org/.', href='https://maps.oceanwealth.org/', target='_blank')
),tags$br(),
               tags$div(tags$a('Turschwell, M. P., Connolly, R. M., Dunic, J. C., Sievers, M., Buelow, C. A., Pearson, R. M., et al. (2021). Anthropogenic pressures and life history predict trajectories of seagrass meadow extent at a global scale. Proc. Natl. Acad. Sci. 118, e2110802118. doi:10.1073/pnas.2110802118/-/DCSupplemental.', href='https://github.com/mpturschwell/Seagrass_pressures_risk', target='_blank')
),tags$br(),
               ...
               tags$div(tags$a('UNEP-WCMC and IUCN (2021), Protected Planet: The World Database on Other Effective Area-based Conservation Measures (WD-OECM) [On-line], [December 2021], Cambridge, UK: UNEP-WCMC and IUCN. Available at: www.protectedplanet.net.', href='https://www.protectedplanet.net', target='_blank')
),tags$br(),
               tags$div(tags$a('UNEP-WCMC, Short FT (2021). Global distribution of seagrasses (version 7.1). Seventh update to the data layer used in Green and Short (2003). Cambridge (UK): UN Environment Programme World Conservation Monitoring Centre. Data DOI: https://doi.org/10.34892/x6r3-d211.', href='https://doi.org/10.34892/x6r3-d211', target='_blank')
),tags$br(),
               tags$div(tags$a('UNESCO Institute for Statistics (2021). Literacy rate, adult total (% of people ages 15 and above). https://data.worldbank.org.', href='https://data.worldbank.org', target='_blank')
)
               ),
